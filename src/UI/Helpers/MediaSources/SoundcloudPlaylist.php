...
class SoundcloudPlaylist extends \Ponticlaro\Bebop\UI\Patterns\MediaSourceAbstract {
            ...
            'html' => '
              {{#id}}
                <div bebop-ui-mod-list--media-source-embed>
                  <iframe width="120" height="120" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/{{id}}&amp;player_type=tiny&amp;auto_play=false&amp;hide_related=true&amp;visual=false&amp;buying=false&amp;sharing=false&amp;download=false&amp;show_bpm=false&amp;bpm=false&amp;show_comments=false&amp;show_playcount=false"></iframe>
                </div>
              {{/id}}'
          ];
          ...
          $sections[] = [
            ...
            'html' => '
              {{^id}}
                ...
                <span class="description">You need to insert a Soundcloud Playlist ID</span>
              {{/id}}'
          ];
            ...
            'html' => '
              {{#id}}
                ...
                <div class="bebop-ui-mod-list--item-title">
                  <a target="_blank" href="https://api.soundcloud.com/playlists/{{id}}">
                    {{#title}}
                      {{title}}
                    {{/title}}
                    {{^title}}
